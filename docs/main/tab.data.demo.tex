...
\end{tabular}
\smallskip\floatfoot{
  \tnd[\dag]{Durations were calculated as the difference between
    current age and age first reported selling sex;
    duration strata in \cite{Baral2014} were denoted:
