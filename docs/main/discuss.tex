\section{Discussion}
\enlargethispage{\baselineskip} % TEMP
...
unmet needs during brief periods of sex work \cite{Knight2020}.
...
% TODO: derive conditions (rates) for heavy-tail in 2-state model in supp?
...
\par
<<TODO>> up to 3 additional paragraphs on:
\\1) source vs active population
\\2) prior work in chronic diseases \& "sojourn times" \eg \cite{Zelen1969}
\\3) more comparison with Fazito2012?
% TODO: Fazito2012 acknowledge that durations were shorter via method 2 vs 3
% ------------------------------------------------------------------------------
