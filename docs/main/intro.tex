...
We sought to offer updated guidance on estimating duration in sex work
...
\begin{enumerate}
  ...
  \item \label{obj:2}
        Develop and apply a Bayesian model of the above relationships to infer
        ...
        first for a single illustrative study \cite{Baral2014}, and
        second for pooled regional estimates from the above review \cite{Fazito2012}.
\end{enumerate}
